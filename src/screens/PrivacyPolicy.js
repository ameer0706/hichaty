      ...
      <View style={{ flex: 1, backgroundColor: '#F8F8F8' }}>
        ...
        <ScrollView  showsVerticalScrollIndicator={false}>
          <View style={styles.content}>
            ...
            <Text style={styles.subHeading}>PRIVACY POLICY & USER AGREEMENT</Text>
            ...
            <Text style={styles.subHeading}>USE AND DISCLOSURE OF INFORMATION</Text>
            <Text style={styles.text}>
            ...
            <Text style={styles.subHeading}>DATA QUALITY AND ACCESS</Text>
            <Text style={styles.text}>
            ...
            <Text style={styles.subHeading}>ASSENT AND MODIFICATIONS TO PRIVACY POLICY</Text>
            <Text style={styles.text}>
            ...
            <Text style={styles.subHeading}>CONCERNS OR COMPLAINTS</Text>
            <Text style={styles.text}>
            ...
            <Text style={styles.subHeading}>USAGE AGREEMENT</Text>
            <Text style={styles.text}>
            ...
            <Text style={styles.subHeading}>I HAVE READ AND UNDERSTAND THE FOREGOING AGREEMENT AND AGREE TO BE BOUND BY ALL OF ITS TERMS.</Text>
