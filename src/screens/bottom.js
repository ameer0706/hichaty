...
export default function Bottom({ route }) {
  ...
  return (
      ...
      screenOptions={({ route }) => ({
        tabBarIcon: ({ focused, color, size }) => {
          if (route.name === 'Contacts') {
            return <SvgXml xml={focused ? activecontact : user_} style={styles.icon} />
          } else if (route.name === 'History') {
            return <SvgXml xml={focused ? activehistory : history} style={styles.icon} />
          } else if (route.name === 'Group') {
            return <SvgXml xml={focused ? activegroup : group} style={styles.icon} />
          } else if (route.name === 'Temchat') {
            return <SvgXml xml={focused ? activetempchat : tempchat} style={styles.icon} />
          } else if (route.name === 'Filmic') {
            return <SvgXml xml={focused ? activeFilmic : filmic} style={styles.icon} />
          }
        },

        tabBarActiveBackgroundColor: "#184564",
    ...
    >
      ...
      <Tab.Screen name="Contacts" options={{ headerShown: false }} component={Cont} />
      <Tab.Screen name="History" options={{ headerShown: false }} component={hist} />
      <Tab.Screen name="Group" options={{ headerShown: false }} component={Group} />
      <Tab.Screen name="Temchat" options={{ headerShown: false }} component={Temchat} />
      <Tab.Screen name="Filmic" options={{ headerShown: false }} component={Filmic} />
